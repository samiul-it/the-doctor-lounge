        ...
        <div className="about-container">
          ...
          <div className="description">
            ...
            <p className='goal-description'>
              ...
              hard and learn professional-level React JS to build my career in
              Web Development.I am following the Programming Hero Course to
              learn web development and our tutor Jhankar Mahbub vai is guiding
              me the right way.
            </p>
          </div>
        </div>
